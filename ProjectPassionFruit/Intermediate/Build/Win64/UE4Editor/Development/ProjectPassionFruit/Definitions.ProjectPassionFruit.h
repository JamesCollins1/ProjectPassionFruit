...
#define ORIGINAL_FILE_NAME "UE4Editor-ProjectPassionFruit.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME ProjectPassionFruit
#define DEPRECATED_FORGAME DEPRECATED
#define PROJECTPASSIONFRUIT_API DLLEXPORT
